...
const AddFilm = () => {
  ...
  //   const checked = e.target.select;

  //   if (checked) {
  //     // Save category id if checked
  //     setFormFilm({
  //       ...getFormFilm,
  //       category_id: [...getFormFilm.category_id, id],
  //     });
  //   } else {
  //     //Delete category id from variable if unchecked
  //     let newCategoryId = getFormFilm.category_id.filter((categoryId) => {
